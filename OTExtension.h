...
public:
    ...
    Vec<ZZ> u, q;
    OTReceiver* R;
    friend class OTReceiver;
    friend class OT;
    friend class OTExtension;
    
    OTSender(bool extended, OT_Pairs x, int n = N, int l = L){
        this->x = x;
        this->n = n;
        this->l = l;
        if(!extended){
...
public:
    ...
    ZZ u;
    OTSender* S;
    friend class OTSender;
    friend class OT;
    friend class OTExtension;
    
    OTReceiver(bool extended, bool* selection_bits, int n = N){
...
public:
    ...
    OT(int n = N, int l = L, OTSender* S = NULL, OTReceiver* R = NULL){
        this->n = n;
        this->l = l;
    ...
    void set_participants(OTSender* S = NULL, OTReceiver* R = NULL){
        this->S = S;
        this->R = R;
        return;
    }
...
public:
    ...
    OTExtension(int n = N, int l = L, OTSender* S = NULL, OTReceiver* R = NULL) : OT(n, l, S, R){}
    ...
    void base_OT(){
        ...
        this->S->R = new OTReceiver(false, selection_bits, KAPPA);
        OT_Pairs k;
        ...
        this->R->S = new OTSender(false, k, KAPPA, KAPPA);
